...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_sort_asc.setStatusTip(_translate("MainWindow", "解密并升序排序所有行"))
        self.action_sort_desc.setText(_translate("MainWindow", "降序排序"))
        self.action_sort_desc.setStatusTip(_translate("MainWindow", "解密并降序排序所有行"))
        ...
        self.action_check_for_updates.setToolTip(_translate("MainWindow", "在浏览器中访问最新版本下载地址"))
        self.action_close.setText(_translate("MainWindow", "关闭(&C)"))
        self.action_close.setToolTip(_translate("MainWindow", "关闭当前加密方式"))
        ...
        self.action_generate_rsa_keystore.setToolTip(_translate("MainWindow", "简单生成RSA私钥并导出"))
